  ...
  <div class="app-entry-wrapper">
    ...
    <div class="col-sm-4 no-gutter">
      <div class="app-content-info-wrapper">
        ...
        <a href="<?php echo $track_view_url; ?>" target="_blank">
        ...
        <h4><em class="faded">Developed by -</em> <a id="developerNameAE" href="<?php echo $artist_view_url; ?>" target="_blank"><?php echo $seller_name; ?></a></h4>
        <h4><em class="faded">Minimum Required OS -</em> <?php echo $minimum_os_version; ?></h4>
        <h4><em class="faded">Current Version -</em> <?php echo $version; ?></h4>
        ...
        <?php echo get_the_term_list( $post->ID, 'genres', '<ul class="styles"><li>', '</li><li>', '</li></ul>' ); ?>
        <h4><em class="faded">Matching Search Terms</em></h4>
        <?php echo get_the_term_list( $post->ID, 'search-terms', '<ul class="styles"><li>', '</li><li>', '</li></ul>' ); ?>
        <h4><em class="faded">Supported Devices</em></h4>
        <?php echo get_the_term_list( $post->ID, 'devices', '<ul class="styles"><li>', '</li><li>', '</li></ul>' ); ?>
      </div>
    </div>
    <div class="col-sm-8">
      ...
      <p class="app-description">
        <?php
         echo nl2br(json_decode($description));
        ?>
      </p>
